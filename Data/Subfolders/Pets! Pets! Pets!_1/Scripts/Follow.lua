local pet = script.parent.parent.parent.parent
local player
...
function Tick(dt)
	if isInit then
		...
		local lerp = dt * 0.2
		if dtPosy > 100 or dtPosx > 100 then
			realpet.animationStance = "unarmed_walk_forward"
			realpet.animationStancePlaybackRate = 1.25;
